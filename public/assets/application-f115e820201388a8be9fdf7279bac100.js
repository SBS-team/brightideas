...
$(document).ready(function(){
    ...
    $("#idea_attachments_path").fileinput({showUpload: false, maxFileCount: 10, mainClass: "input-group-lg"});
    $('.redactor').wysihtml5();
})
;
(function() {
  $(document).ready(function() {
    $('.tag.label.label-info').click(function() {
      return $('.tag.label.label-info').popover('hide');
    });
    $('.tag.label.label-info').popover({
      placement: "bottom"
    });
    $('.upvote').upvote();
  });
...
(function ($) {
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal) {
      ...
      // add a tag element
      var $tag = $('<span data-content="And heres some amazing content. Its very engaging." data-content="Default popover" data-toggle="popover" class="tag ' + htmlEncode(tagClass) + '">' + htmlEncode(itemText) + '<span data-role="remove"></span></span>');
      $tag.data('item', item);
